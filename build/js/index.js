...
let inputValues = []; //array to store what user is entering
let calcValues = []; //array to store what should be added to expression itself actually
let memoryArray = []; //array to store memory operation values
let equalFlag = false; //indicates if user has already pressed equal button
function getMemory() {
...
getMemory();
function backspace(inputArr, calcArr) {
...
function evaluateExpression(calcArr) {
    try {
...
function display(inputArr, input) {
...
function signInversion(inputArr, calcArr) {
...
function trigonometry(sign, deg) {
        ...
        switch (e.target.id) {
            ...
            case "m+":
                ...
                if (!calcValues.length)
                    ...
                    temp = parseFloat(calcValues.join(""));
            ...
            case "equal":
                let ans = evaluateExpression(calcValues);
